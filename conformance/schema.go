...
// duplicate top-level names within a kind. The ref= identity-constraint form,
// the not-yet-produced complexType forms (<simpleContent> <restriction>, inline
// anonymous local types) and the redefining <complexType> (#286) are SILENTLY
// SKIPPED or declined (§3.1.2 permits ignoring a not-yet-produced
