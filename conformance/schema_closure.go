...
// inline anonymous type, a list/union simpleType — or one it builds with a rule
// judging it only in part (a <complexContent> <extension>: cos-ct-extends landed
// with #264, but its clauses 1.3 and 1.7 stay fail-open until #265's base folds)
