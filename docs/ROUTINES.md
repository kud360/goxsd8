...
|---|---|---|---|
| backlog | `/backlog` | daily 12:00 (local 08:00) | reconcile issues, keep the ready queue dependency-ordered (#347) |
| develop | `/develop` | 18:00, 00:00, 06:00 (local 14:00, 20:00, 02:00) | one issue → one commit |
| retro | `/retro` | weekly, Sun 13:00 (local Sun 09:00) | process self-improvement + architecture audit |
...
go tool commentwrap ./...                          # gate, part 3 (ragged comment wraps; -fix reflows them)
