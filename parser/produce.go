...
//
// The walk is confined to what THIS producer actually maps: prescan withholds
// the composition directives' subtrees (compositionDirective), whose contents
// belong to another document's producer.
