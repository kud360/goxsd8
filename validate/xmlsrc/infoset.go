...
// them (STYLE T4), so a character-data node is handed over as it is.
var (
...
func (c *children) Next() (validate.Child, bool) {
	...
	for {
		...
		case *xmltree.StartElement:
			return validate.ElementChild(&element{w: c.w, start: n, depth: at + 1}), true
